...
class TGMDK_MerchantUtility {
     ...
     * @access public
     * @static
     * @param value メッセージダイジェスト算出の対象となる文字列
     * @param key   メッセージダイジェスト算出キー
     * @return ダイジェスト値
     */
     ...
     * @access public
     * @static
     * @param value メッセージダイジェスト算出の基になる文字列
     * @param key メッセージダイジェスト算出キー
     * @param originalDigest 事前に算出済のダイジェスト値
     ...
     * @access public
     * @static
     * @param data マーチャントデータを生成するためにマーチャントが設定したデータ
     * @return マーチャントデータ
     */
