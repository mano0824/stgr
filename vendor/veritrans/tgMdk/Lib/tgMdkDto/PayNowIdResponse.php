...
class PayNowIdResponse {
     ...
     * @param processId PayNowID処理番号<br>
     */
     ...
     * @param message PayNowIDメッセージ<br>
     */
     ...
     * @param optionResults PayNowID結果オプション<br>
     */
