...
class CardEmvAuthorizeResponseDto extends MdkBaseDto
{
    ...
    /**
     * 応答ICカードデータを設定する<br>
     * @param  resEmvData 応答ICカードデータ<br>
     */
     ...
     * @param  reqIsOffline 要求オフライン取引フラグ<br>
     */
     ...
     * @param  reqIsAdvice 要求アドバイス取引フラグ<br>
     */
    ...
    /**
     * 要求与信日時を設定する<br>
     * @param  reqAuthDatetime 要求与信日時<br>
     */
    ...
    /**
     * 要求レスポンスコードを設定する<br>
     * @param  reqResponseCode 要求レスポンスコード<br>
     */
     ...
     * @param  reqChipConditionCode 要求チップコンディションコード<br>
     */
    ...
    /**
     * 要求強制オンラインを設定する<br>
     * @param  reqForcedOnline 要求強制オンライン<br>
     */
    ...
    /**
     * 要求強制承認を設定する<br>
     * @param  reqForcedApproval 要求強制承認<br>
     */
    ...
    /**
     * 要求オフライン区分を設定する<br>
     * @param  reqOfflineType 要求オフライン区分<br>
     */
    ...
    /**
     * 要求支払タイプを設定する<br>
     * @param  reqPaymentType 要求支払タイプ<br>
     */
