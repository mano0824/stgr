...
class MpiAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * @param  reqHttpUserAgent 要求HTTPユーザエージェント<br>
     */
    ...
    /**
     * 要求HTTPアセプトを設定する<br>
     * @param  reqHttpAccept 要求HTTPアセプト<br>
     */
    ...
    /**
     * 応答コンテンツを設定する<br>
     * @param  resResponseContents 応答コンテンツ<br>
     */
    ...
    /**
     * 応答会社IDを設定する<br>
     * @param  resCorporationId 応答会社ID<br>
     */
     ...
     * @param  res3dMessageVersion 応答3Dセキュアメッセージバージョン<br>
     */
