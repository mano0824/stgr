...
class MasterpassLoginRequestDto extends AbstractPaymentRequestDto
{
     ...
     * 表示用商品数量2を指定します。<br/>
     * 1以上<br/>
     * 表示用商品説明2、表示用商品金額3、表示用商品イメージURL2のいずれかが指定されている場合、必須<br/>
     */
    private $quantity2;
     ...
     * 表示用商品数量3を指定します。<br/>
     * 1以上<br/>
     * 表示用商品説明3、表示用商品金額3、表示用商品イメージURL2のいずれかが指定されている場合、必須<br/>
     */
    private $quantity3;
    ...
    /**
     * 表示用商品説明1を設定する<br>
     * @param description1 表示用商品説明1<br>
     */
     ...
     * @param imageUrl1 表示用商品イメージURL1<br>
     */
    ...
    /**
     * 表示用商品説明2を設定する<br>
     * @param description2 表示用商品説明2<br>
     */
     ...
     * @param imageUrl2 表示用商品イメージURL2<br>
     */
    ...
    /**
     * 表示用商品説明3を設定する<br>
     * @param description3 表示用商品説明3<br>
     */
     ...
     * @param imageUrl3 表示用商品イメージURL3<br>
     */
    ...
    /**
     * 表示用商品説明4を設定する<br>
     * @param description4 表示用商品説明4<br>
     */
     ...
     * @param imageUrl4 表示用商品イメージURL4<br>
     */
    ...
    /**
     * 表示用商品説明5を設定する<br>
     * @param description5 表示用商品説明5<br>
     */
     ...
     * @param imageUrl5 表示用商品イメージURL5<br>
     */
    ...
    /**
     * 表示用商品説明6を設定する<br>
     * @param description6 表示用商品説明6<br>
     */
     ...
     * @param imageUrl6 表示用商品イメージURL6<br>
     */
    ...
    /**
     * 表示用商品説明7を設定する<br>
     * @param description7 表示用商品説明7<br>
     */
     ...
     * @param imageUrl7 表示用商品イメージURL7<br>
     */
    ...
    /**
     * 表示用商品説明8を設定する<br>
     * @param description8 表示用商品説明8<br>
     */
     ...
     * @param imageUrl8 表示用商品イメージURL8<br>
     */
    ...
    /**
     * 表示用商品説明9を設定する<br>
     * @param description9 表示用商品説明9<br>
     */
     ...
     * @param imageUrl9 表示用商品イメージURL9<br>
     */
    ...
    /**
     * 表示用商品説明10を設定する<br>
     * @param description10 表示用商品説明10<br>
     */
     ...
     * @param imageUrl10 表示用商品イメージURL10<br>
     */
    ...
    /**
     * 配送先抑止フラグを設定する<br>
     * @param suppressShippingAddress 配送先抑止フラグ<br>
     */
    ...
    /**
     * 配送先許可エリアを設定する<br>
     * @param shippingLocationProfile 配送先許可エリア<br>
     */
    ...
    /**
     * 認証キャンセル時URLを設定する<br>
     * @param cancelUrl 認証キャンセル時URL<br>
     */
