...
class LinepayAuthorizeRequestDto extends AbstractPaymentRequestDto
{
    ...
    /**
     * 使用ブラウザ判定を設定する<br>
     * @param checkUseBrowser 使用ブラウザ判定<br>
     */
     ...
     * @param appUrlScheme アプリ起動URLスキーム<br>
     */
     ...
     * @param useOriginalApp 独自アプリ起動時のオプション指定<br>
     */
    ...
    /**
     * packageNameを設定する<br>
     * @param packageName packageName<br>
     */
    ...
    /**
     * 決済キャンセル時URLを設定する<br>
     * @param cancelUrl 決済キャンセル時URL<br>
     */
    ...
    /**
     * 決済確認方法を設定する<br>
     * @param paymentConfirmType 決済確認方法<br>
     */
