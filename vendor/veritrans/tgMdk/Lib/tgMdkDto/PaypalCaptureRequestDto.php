...
class PaypalCaptureRequestDto extends AbstractPaymentRequestDto
{
    ...
    /**
     * ヘッダーイメージURLを設定する<br>
     * @param  headerImageUrl ヘッダーイメージURL<br>
     */
    ...
    /**
     * オーダー説明を設定する<br>
     * @param  orderDescription オーダー説明<br>
     */
    ...
    /**
     * 配送先郵便番号を設定する<br>
     * @param  shipPostalCode 配送先郵便番号<br>
     */
