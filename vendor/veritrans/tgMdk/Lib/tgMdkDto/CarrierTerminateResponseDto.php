...
class CarrierTerminateResponseDto extends MdkBaseDto
{
    ...
    /**
     * リダイレクトURLを設定する<br>
     * @param redirectUrl リダイレクトURL<br>
     */
    ...
    /**
     * レスポンスコンテンツを設定する<br>
     * @param responseContents レスポンスコンテンツ<br>
     */
     ...
     * @return 継続課金終了日時（YYYYMMDDhhmmss）<br>
     */
     ...
     * @param terminateDatetime 継続課金終了日時（YYYYMMDDhhmmss）<br>
     */
