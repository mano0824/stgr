...
class CarrierTerminateRequestDto extends AbstractPaymentRequestDto
{
     ...
     * @param successUrl 継続課金終了完了時URL<br>
     */
     ...
     * @param cancelUrl 継続課金終了キャンセル時URL<br>
     */
     ...
     * @param errorUrl 継続課金終了エラー時URL<br>
     */
