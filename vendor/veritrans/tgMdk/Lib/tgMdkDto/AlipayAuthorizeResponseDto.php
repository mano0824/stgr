...
class AlipayAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * @return Alipayリダイレクト用HTMLフォーム文字列<br>
     */
     ...
     * @param entryForm Alipayリダイレクト用HTMLフォーム文字列<br>
     */
    ...
    /**
     * 請求金額（中国元）を設定する<br>
     * @param buyerChargedAmountCny 請求金額（中国元）<br>
     */
