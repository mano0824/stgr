...
class MasterpassAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * @param authorizeDatetime 取引日時（YYYYMMDDhhmmss）<br>
     */
    ...
    /**
     * カード決済取引IDを設定する<br>
     * @param cardOrderId カード決済取引ID<br>
     */
