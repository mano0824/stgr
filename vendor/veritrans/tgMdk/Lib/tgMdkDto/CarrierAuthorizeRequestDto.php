...
class CarrierAuthorizeRequestDto extends AbstractPaymentRequestDto
{
     ...
     * - true : 与信同時売上<br/>
     * - false: 与信のみ<br/>
     * ※ 未指定の場合は、false:与信のみ。ただし、sb_matometeはtrue:与信同時売上として扱います。<br/>
     */
    private $withCapture;
     ...
     * OpenIDは、決済申込完了通知によりVeriTrans3Gから店舗側システムに連携されます。<br/>
     * <br/>
    ...
    /**
     * 都度/継続区分を設定する<br>
     * @param accountingType 都度/継続区分<br>
     */
    ...
    /**
     * auIDログインフラグを設定する<br>
     * @param loginAuId auIDログインフラグ<br>
     */
