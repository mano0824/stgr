...
class PaypalAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * 半角英数字<br>
     * 127文字以内<br>
     * 3GPSGWが発番するオーダー単位でユニークとなるIDが格納されます。<br>
     */
    private $invoiceId;
    ...
    /**
     * 支払ステータスを設定する<br>
     * @param  paymentStatus 支払ステータス<br>
     */
    ...
    /**
     * 決済センタ承認IDを設定する<br>
     * @param  centerAuthId 決済センタ承認ID<br>
     */
