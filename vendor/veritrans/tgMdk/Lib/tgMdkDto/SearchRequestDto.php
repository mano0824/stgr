...
class SearchRequestDto extends MdkBaseDto {
     ...
     *
     * @return $this->最新トランザクションのみフラグ<br>
     */
     ...
     *
     * @param newerFlag 最新トランザクションのみフラグ<br>
     */
     ...
     * ダミー決済対象フラグを設定する<br>
     *
     * @param containDummyFlag ダミー決済対象フラグ<br>
     */
     ...
     * 検索キーを設定する<br>
     *
     * @param searchParameters 検索キー<br>
     */
