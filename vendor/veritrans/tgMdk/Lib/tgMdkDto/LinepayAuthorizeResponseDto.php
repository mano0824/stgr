...
class LinepayAuthorizeResponseDto extends MdkBaseDto
{
    ...
    /**
     * LINEPay取引IDを設定する<br>
     * @param linepayOrderId LINEPay取引ID<br>
     */
     ...
     * @param redirectWebUrl リダイレクトするWebURL<br>
     */
     ...
     * @param redirectAppUrl LINEにアプリ間移動するURL<br>
     */
