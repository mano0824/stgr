...
class SaisonCaptureResponseDto extends MdkBaseDto
{
     ...
     * @param aqfPointBalance 処理後永久不滅ウォレット残高<br>
     */
     ...
     * @param cardServiceType 決済サービスタイプ（カード決済）<br>
     */
     ...
     * @param cardMstatus 処理結果コード（カード決済）<br>
     */
     ...
     * @param cardVResultCode 詳細結果コード（カード決済）<br>
     */
     ...
     * @param cardMerrMsg エラーメッセージ（カード決済）<br>
     */
    ...
    /**
     * 電文ID（カード決済）を設定する<br>
     * @param cardMarchTxn 電文ID（カード決済）<br>
     */
    ...
    /**
     * 取引ID（カード決済）を設定する<br>
     * @param cardOrderId 取引ID（カード決済）<br>
     */
     ...
     * @param cardCustTxn 取引毎に付くID（カード決済）<br>
     */
     ...
     * @param cardTxnVersion MDK バージョン（カード決済）<br>
     */
    ...
    /**
     * 要求仕向け先コードを設定する<br>
     * @param reqAcquirerCode 要求仕向け先コード<br>
     */
    ...
    /**
     * 要求支払種別情報を設定する<br>
     * @param reqJpoInformation 要求支払種別情報<br>
     */
     ...
     * @param cardTradUrl trAd広告ＵＲＬ(カード決済用)<br>
     */
