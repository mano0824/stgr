...
class BankFinancialInstInfo {
     ...
     * デバイスコードを設定する<br>
     *
     * @param deviceCode デバイスコードコード<br>
     */
     ...
     * カナ行頭文字を設定する<br>
     *
     * @param bankIndexChar2 カナ行頭文字<br>
     */
