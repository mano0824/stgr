...
class CardEmvAuthorizeRequestDto extends AbstractPaymentCreditRequestDto
{
    ...
    /**
     * レスポンスコードを設定する<br>
     * @param responseCode レスポンスコード<br>
     */
     ...
     * @param chipConditionCode チップコンディションコード<br>
     */
    ...
    /**
     * 非接触取引指定を設定する<br>
     * @param isContactless 非接触取引指定<br>
     */
    ...
    /**
     * 非接触区分を設定する<br>
     * @param contactlessType 非接触区分<br>
     */
