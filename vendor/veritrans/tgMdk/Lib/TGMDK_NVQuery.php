...
class TGMDK_NVQuery {
     ...
     *
     * @access public
     * @param $requestDto　決済コマンド要求Dto<br>
     */
     ...
     *
     * @access public
     * @param Array　NVリスト<br>
     * @param Dto　処理対象Dto<br>
     * @param String Name階層（再帰呼出時に引き渡される）<br>
     ...
     * @access private
     * @param Array N=Vリスト
     * @param $method　指定パラメータのgetter名<br>
     * @param $requestDto　処理対象Dto<br>
     * @param $NameString Name階層（再帰呼出時に引き渡される）<br>
