...
class TGMDK_ContentHandler {
     ...
     *
     * @access public
     * @param $hashData JSON形式から連想配列に変換したGW処理結果
     * @param $responseDto 応答Dto
     ...
     * @param $responseDto 応答Dto
     * @param $ignoreList 無視する項目（パス）の配列
     * @return JSONを設定した応答Dto
     */
     ...
     * @return type マスク化したJSON形式のGW処理結果
     */
    ...
    */
     ...
     * @access private
     * @param &$array 配列
     * @return 連想配列である場合はtrueを取得する。それ以外の場合はfalseを取得する。
     */
     ...
     * @access private
     * @param $obj オブジェクト
     * @param $attrAccessorName アクセサメソッド名
     * @return アクセサメソッドの型の名称
     */
